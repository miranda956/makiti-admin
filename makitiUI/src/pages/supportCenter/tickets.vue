<template>
  <div class="tables-basic">
    <h2 class="page-title">Tickets <span class="fw-semi-bold"></span></h2>
    ...
    <b-row>
      <b-col>
        <Widget
          title="<h5>Tickets<span class='fw-semi-bold'>Lists</span></h5>"
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>TICKET ID</th>
                  <th>EMAIL</th>
                  <th class="hidden-sm-down">USER CONTACT</th>
