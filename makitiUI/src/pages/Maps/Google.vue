<template>
  <div class="tables-basic">
    <h2 class="page-title">Permission <span class="fw-semi-bold"></span></h2>
       
       <router-link to="/">        <button type="button" class="btn btn-primary">ADD Permission</button>
</router-link>

    <b-row>
      <b-col>
        <Widget
          title="<h5>PERMISSION<span class='fw-semi-bold'>Lists</span></h5>"
